...
export default {
  ...
  head: {
    ...
    link: [
      ...
      },
      {
        ...
        type: 'text/css',
        href:
          'https://fonts.googleapis.com/css2?family=Dongle&family=Nunito+Sans:ital,opsz,wght@0,6..12,200..1000;1,6..12,200..1000&display=swap',
      },
    ],
    script: [
      {
  ...
  plugins: [
    ...
    { src: '~/plugins/google-ad-1.js', mode: 'client' },
    { src: '~/plugins/google-ad-2.js', mode: 'client' },
