            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <p>
                            User Host adalah user yang berlangganan provider Entertainment via Seakun.id dan user 
                            yang bertanggung-jawab melakukan payment ke provider Entertainment menggunakan kartu 
                            debit/kredit pribadi miliknya. Penggantian dana akan dilakukan setelah proses pembayaran 
                            selesai.
                        </p>
                        <p>
...
export default {
    ...
    methods: {
        getPaymentDetail() {
            ...
            axios
                .get(
                    `https://seakun-packet-api.herokuapp.com/${provider.toLowerCase()}/${packet_id}`
                )
                .then((res) => {
