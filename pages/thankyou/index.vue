<template>
  <div class="thankyou max-w-2xl  w-full mx-auto mt-10 py-4">
      ...
      <img class="w-9/12 mx-auto" src="/images/thank-you.png" alt="Image not found" />
      <div class="thankyou-wording text-center px-12">
        ...
        <p class="text-center text-lg mt-4 text-gray-500">
            Konfirmasi pembayaranmu telah berhasil. Admin akan segera menghubungi untuk memberikan detail pesananmu.
        </p>
      </div>
      <div class="detail-order bg-white px-12 mt-12 py-4">
          <div class="border-b-2 border-gray-200 pb-3">
              ...
              <div class="flex justify-between items-center mt-2">
                  ...
                  <img class="w-3/12"  src="images/payment/mandiri.png">
              </div>
          </div>
           <div class=" mt-4">
                <p class="text-lg text-gray-400">Bank Tujuan</p>
                <p class="font-bold text-lg  mt-2">Mandiri a.n PT Seakun Indonesia </p>
          </div>
          <div class=" mt-4">
                <p class="text-lg text-gray-400">Nama Rekening</p>
                <p class="font-bold text-lg  mt-2">Putra Adi Wiguna </p>
          </div>
