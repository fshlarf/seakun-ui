<template>
  <div
    id="pricing-sequrban"
    class="container-sequrban tn:pt-12 lg:pt-20 flex tn:flex-col md:flex-row md:justify-between md:items-center"
  >
    <div
    ...
    >
      ...
      >
        Sapi seharga Rp11.500.000 dengan berat -+ 200 kg dibagi sama rata
        biayanya ke 7 orang.
      </div>
      <div
      ...
      >
        <div class="flex justify-between items-center">
          <div class="flex items-center tn:space-x-2 lg:space-x-3">
            <img
              ...
              src="/images/sequrban/icons/label.svg"
              alt="harga sapi"
            />
        ...
        <div class="flex justify-between items-center">
          <div class="flex items-center tn:space-x-2 lg:space-x-3">
            <img
              class="tn:w-[15px] lg:w-[20px]"
              src="/images/sequrban/icons/user.svg"
              alt="harga per orang"
            />
        ...
        <div class="flex justify-between items-center">
          <div class="flex items-center tn:space-x-2 lg:space-x-3">
            <img
              class="tn:w-[15px] lg:w-[20px]"
              src="/images/sequrban/icons/percent.svg"
              alt="biaya admin"
            />
            <p class="font-bold">Biaya admin Seakun</p>
          </div>
          <p class="font-bold">Rp107.143</p>
        </div>
        <div
      ...
      >
        Dengan biaya sebesar <b>Rp1.750.000</b> kamu sudah bisa menunaikan
    ...
    >
      <img src="/images/sequrban/pricing.png" alt="detail harga" />
    </div>
  </div>
</template>
