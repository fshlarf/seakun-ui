  ...
  methods: {
    scrollToSection(id) {
      if (id === 0) {
        ...
        const providerSection = document.getElementById('journey-header');
        ...
        const penggunaSection = document.getElementById('journey-journey');
        ...
        const orderFlowSection = document.getElementById(
          'journey-coming-product'
        );
        ...
        const testimonySection = document.getElementById('journey-team');
        ...
        const qnaSection = document.getElementById('journey-donation');
