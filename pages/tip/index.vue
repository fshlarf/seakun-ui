<template>
  <div id="general-gift" class="">
    <div
      class="tn:bg-primary md:bg-white md:!container md:w-3/4 md:mx-auto tn:pt-8 lg:pt- tn:px-2"
    >
      <img
        src="/images/general-gift/banner.png"
        alt="tips untuk seakun"
        class="w-full"
      />
    </div>
    <div
    ...
    >
      ...
      >
        <div class="text-white lg:w-[588px] tn:text-center lg:text-left">
          <h2 class="text-[16px] lg:text-[28px] font-bold">Donatur TIPS</h2>
          <p class="text-[14px] lg:text-[18px] tn:mt-2">
            Daftar pengguna Seakun yang memberikan apresiasi terbaik berupa TIPS
        ...
        <div>
          ...
          >
            ...
            <span class="tn:ml-1">Kirim TIPS untuk Seakun</span>
          </Button>
        </div>
      </div>
    ...
    >
      ...
      >
        ...
        <p class="tn:mt-3">
          ...
          Seakun berikan, kakak bisa mengirimkan TIPS untuk Tim Seakun yang
          bertugas dengan cara klik tombol <b>Kirim TIPS untuk Seakun</b> di
          atas.
        </p>
      ...
      >
        ...
        <p class="tn:mt-3">
          ...
          tanpa ada paksaan dari pihak manapun. Program TIPS untuk Seakun ini
