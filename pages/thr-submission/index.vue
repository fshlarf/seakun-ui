<template>
  <div class="max-w-[1000px] mx-auto tn:pt-4 lg:pt-8">
    ...
    >
      <h1 class="text-[20px] lg:text-[32px] font-bold">Isi Data Donatur THR</h1>
      <p class="tn:text-[12px] md:text-[14px] tn:mt-3">
        Silahkan isi data di bawah agar nama kakak bisa masuk ke dalam List
        Donatur THR dan ditampilkan di website Seakun.
      </p>
      <div
      ...
      >
        ...
        web Seakun. Klik
        <nuxt-link to="/thr" class="font-bold underline">link ini</nuxt-link>
      ...
      <div class="tn:mt-8">
        ...
        <div class="flex items-center space-x-3 tn:mt-3">
          ...
          <p class="tn:text-[14px] opacity-50">
            Sembunyikan nama pada list donatur: "R****e Y**l"
          </p>
        </div>
        ...
        <div v-if="socialMedia" class="flex items-center space-x-3 tn:mt-3">
          ...
          <p class="tn:text-[14px] opacity-50">
            Sembunyikan username pada list donatur: "S******b"
          </p>
        </div>
        ...
        <div class="flex items-center space-x-3 tn:mt-3">
          ...
          <p class="tn:text-[14px] opacity-50">
            Sembunyikan nominal THR pada list donatur: "RpXX.XXX"
          </p>
        </div>
    ...
    onClickSubmitData() {
      ...
      if (!this.nominal) {
        this.errorForm.nominal = {
          isError: true,
          message: 'Nominal THR harus di isi',
        };
        isValid = false;
