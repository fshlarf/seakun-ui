    ...
    >
      <div>
        ...
        <template v-if="showLabel">
          <CategoryTag
            :label="
              article && article.blogCategory
                ? article.blogCategory[0].name
                : ''
            "
            :type="labelType"
          />
        ...
        <!-- Title -->
        <h3
          :class="`mb-1 mt-1 font-title md:mt-2 ${titleSize} font-bold text-white`"
        >
          {{ article.title }}
        </h3>
        ...
        <!-- Description -->
        <div
          :class="`flex items-center ${descriptionSize} gap-2 font-main text-white md:gap-3`"
        >
          <span>Seakun.id</span>
          ...
          <div class="flex items-center">
            ...
            <p class="px-2 text-[10px] text-white md:text-xs">
