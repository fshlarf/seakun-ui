<template>
  <!-- Lainnya Film -->
  <div class="container-seakun-blog mb-4">
    <section class="mb-16 mt-6">
      <div class="mb-4 flex items-center justify-between">
        <div class="title-font flex items-center">
          <label class="text-[16px] font-bold text-mainseakun-blog/film/"
            >Lainnya&nbsp;</label
          >
      ...
      <div
        class="grid w-full grid-cols-1 items-center justify-between gap-5 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4"
      >
        <Card
          show-author
          card-type="top"
...
export default {
  ...
  computed: {
    paginatedPage() {
      ...
      return this.film_list.slice(start, end);
    },
    total() {
      return Math.ceil(this.film_list.length / this.limit);
    },
  },
  methods: {
    prevPage() {
