<template>
  ...
  >
    ...
    >
      <div class="text-center text-gray-secondary w-[228px] sm:w-[420px]">
        <p class="text-sm sm:text-base lg:text-lg font-bold">
          Event Sefoursary Telah Berakhir
        </p>
        <p class="text-xs sm:text-sm mt-2">
          Terima kasih atas partisipasinya dan semoga kamu menang di live undian
          Sefoursary ya! Sampai ketemu di live IG @seakun.id tanggal 9 September
          2024! 👋
        </p>
      </div>
      <div
