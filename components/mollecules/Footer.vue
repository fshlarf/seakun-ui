      ...
      <div class="container">
        <div class="row clearfix">
          ...
          <div class="col-md-4 col-sm-6 col-xs-12" id="contact-us">
            ...
            <div class="footer__widget-text">
              <ul class="footer__widget-contact">
                <li
                  class="footer__widget-contact-icon"
          ...
          <div class="col-md-4 col-sm-6 col-xs-12">
            <h3 class="footer__widget-title">Kirim Email</h3>
            <div class="footer__widget-text">
              Kirim Email Anda di bawah ini, untuk mendapatkan informasi lebih
              lanjut tentang ketentuan dan layanan kami.
            </div>
            <div>
              <form method="post">
    ...
    &-social {
      ...
      li {
        ...
        a {
          ...
          text-align: center;
          font-size: 13px;
          background: rgba(255, 255, 2550, 0.05);
          color: #bbbbbb;
          transition: all 500ms ease;
