<template>
  <div
    @click="clickRegisterBtn(dataCustomer.names)"
    :class="`card card-${setClassStatus(dataCustomer.names)}`"
    v-if="dataCustomer"
  >
    <div class="card-header">
      <div class="card-header--title">
        ...
        <img
          :src="`/images/${
            dataCustomer.provider && dataCustomer.provider.toLowerCase()
          }.png`"
          alt="Netflix"
        />
      </div>
    ...
    <div class="card-content">
      <ul>
        <li
          v-for="(name, index) in dataCustomer.names"
          :key="index"
      ...
      <div
        ...
        v-if="isButtonShow(dataCustomer.names)"
        @click="clickRegisterBtn(dataCustomer.names)"
      >
