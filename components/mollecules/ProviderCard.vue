<template>
    ...
    >
      ...
      <div class="flex tn:my-2 tn:gap-2 items-center">
        <div
          class="tn:w-[30px] tn:h-[30px] md:w-[60px] md:h-[60px] bg-[#F7F7F7] flex justify-center items-center tn:rounded-md"
        >
          <img
            class="w-3/4"
      ...
      <div class="bg-[#ECECEC] h-[0.5px] w-full" />
      ...
      <div class="w-full tn:h-[87px] md:h-[110px]"></div>
  
      <div class="w-full absolute z-10 bottom-0 left-0 tn:p-2 md:p-[14px]">
        <div class="w-full">
          <div class="bg-[#ECECEC] h-[0.5px] w-full" />
          <div class="tn:my-2 tn:pr-2 flex justify-between items-center">
            <div
            ...
            >
              <img
                ...
                alt="member icon"
              />
              <p class="font-bold tn:text-[10px] md:text-[14px]">
