<template>
  ...
  >
    ...
    <div class="static z-0 w-full text-gray-700">
      <div
        class="container-about-us lg:flex lg:justify-between lg:items-center"
      >
        <nuxt-link to="/">
...
export default {
  data() {
    return {
      ...
      navbarLink: [
        ...
        {
          id: 4,
          label: 'Layanan Mendatang',
          tag: 'service-coming-soon',
        },
        {
          id: 5,
          label: 'Dukung Seakun',
  ...
  methods: {
    handleScrollEffect() {
      const myNav = document.getElementById('navbar-about-us');
      if (
