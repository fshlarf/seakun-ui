<template>
  <div class="">
    <button
      class="button-dropdown flex justify-between items-center w-full border-2 tn:rounded-lg text-[#A0A3BD] border-[#A0A3BD] tn:py-3 tn:px-4 bg-white text-sm font-medium focus:outline-none"
      id="menu-button"
      :disabled="disabled"
      aria-expanded="true"
      aria-haspopup="true"
