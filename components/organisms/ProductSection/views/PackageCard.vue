<template>
    ...
    >
      ...
      <div class="tn:p-4 tn:pb-0 md:px-8 md:pt-4 bg-white">
        <div class="benefits space-y-1">
          ...
          >
            ...
            <p
              class="tn:font-medium md:font-medium w-[90%] tn:text-sm md:text-[15px] text-gray-600"
            >
              {{ benefit.description }}
            </p>
          </div>
      ...
      <div
        class="w-full tn:mt-2 md:mt-3 tn:space-y-1 tn:px-3 md:px-4"
      ...
      <div class="w-full tn:mt-3 md:mt-4 tn:px-3 tn:pb-3 md:px-4 md:pb-4">
        <Button
