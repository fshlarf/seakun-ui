                ...
                >
                    ...
                    <div class="dropdown__item item" v-if="packet.userHost">
                        <div>
                            ...
                            Memiliki Kartu Debit/Kredit Internasional yang dapat
                            digunakan untuk melakukan pembayaran ke Netflix,
                            Seperti Jenius, BNI Internasional dan lainnya.
                        </div>
                    </div>
                    <div class="dropdown__item item" v-if="packet.userHost">
                        <a
