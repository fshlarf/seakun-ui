            ...
            <form>
              ...
              <div class="form-group">
                <ButtonDrop
                  ...
                  :btnText="provider"
                />
                <p class="error-msg" v-if="errorMsg.provider">
                  {{ errorMsg.provider }}
                </p>
              </div>
              ...
              <div class="form-group">
                <ButtonDrop
                  ...
                  :btnText="packet"
                />
                <p class="error-msg" v-if="errorMsg.packet">
                  {{ errorMsg.packet }}
                </p>
              </div>
  ...
  methods: {
    ...
    validateInput() {
      ...
      this.provider == 'Contoh: Netflix'
        ? (this.errorMsg.provider = 'Provider Entertainment harus dipilih')
    ...
    getPacketData(provider) {
      axios
        .get(
          `https://seakun-packet-api-v2.herokuapp.com/${provider.toLowerCase()}`
        )
        .then((res) => {
    ...
    postRegisteredUser() {
      ...
      axios
        .post('https://seakun-api-v2.herokuapp.com/registered-user', payload, {
          headers: headers,
        })
        .then((res) => {
    ...
    choosePacket(packet) {
      ...
      this.provider.toLowerCase() == 'netflix' &&
    ...
    executeApiMailSeakun(payload) {
      ...
      axios
        ...
        .then((res) => {
          ...
          this.$router.push({
            path: this.setPathToRedirect(this.choosedPacket),
            query: {
              provider: this.provider,
